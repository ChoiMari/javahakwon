...
@WebServlet (name="postListConroller", urlPatterns= {"/post/list"})
public class PostListController extends HttpServlet{
	...
	private final PostService postService = PostService.INSTANCE; //final은 반드시 명시적으로 초기화되는 코드가 있어야함(선언시 바로 초기화 하거나, 생성자로)
